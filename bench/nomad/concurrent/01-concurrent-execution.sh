...
# rust-spin-user-manager rust-wasmedge-user-manager rust-wasmedge-user-manager-socket 
#for test_type in rust-spin-whatlang rust-spin-n-body rust-spin-aes rust-spin-prime-numbers rust-spin-fuzzysearch-http rust-spin-audio-sine-wave 
for test_type in rust-wasmedge-whatlang rust-wasmedge-n-body-socket rust-wasmedge-fuzzysearch-http-socket rust-wasmedge-whatlang-socket rust-wasmedge-prime-numbers-socket rust-wasmedge-n-body rust-wasmedge-aes rust-wasmedge-prime-numbers rust-wasmedge-audio-sine-wave
do
